...
export default function Contact(props){
    ...
    return (
        <div ref={contactCRef} className='contact'>
            <motion.div style={{position, x}} className='contact_inner'>
                {submitted && (<motion.div initial className='submitted'>
                    <p>Thank you for your message.</p>
                </motion.div>)
                }
                <div className='contact_inner_content'>
                    <div className='contact_inner_bg'>
                        <div className='contact_form'>
                            <h3>I'd love to hear from you</h3>
                            <div ref={props.contact} className='contact_form_inner'>
                                ...
                                <div className='contact_other'>
                                    ...
                                    <a href="https://www.linkedin.com/in/maksym-kozlov-82b6001b6/?originalSubdomain=it">
                                        <svg width="50px" height="50px" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
